...
public class CategoryController {
	...
	//create
	@PostMapping("/")
	public ResponseEntity<CategoryDto> createCategory(@Valid @RequestBody CategoryDto cateodDto){
		CategoryDto createCategory =this.categoryService.createCategory(cateodDto);
