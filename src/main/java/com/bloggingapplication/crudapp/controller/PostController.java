...
import com.bloggingapplication.crudapp.config.AppConstants;
...
import com.bloggingapplication.crudapp.services.FileService;
...
public class PostController {
	...
	//get post by particular post Id
	...
	// find post title using given keyword
	...
	public void imageUploader(@PathVariable ("imageName") String imageName,HttpServletResponse response) throws IOException {
